      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl overflow-hidden"
        ...
        <form onSubmit={onSubmit} className="flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-1/3 bg-gray-50 p-8 flex flex-col items-center border-r border-gray-100">
            ...
            <div className="w-full aspect-square border-2 border-dashed border-gray-300 rounded-xl flex flex-col items-center justify-center bg-white relative overflow-hidden group hover:border-yellow-400 transition-colors">
              {formData.image ? (
              ...
              <div className="absolute inset-0 bg-black/50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                ...
                >
                  <label className="cursor-pointer bg-white text-yellow-600 px-4 py-2 rounded-full font-bold shadow-lg hover:bg-yellow-50 transition-transform hover:scale-105 border border-yellow-200">
