      ...
      >
        ...
        <div className="relative bg-gradient-to-r from-blue-600 to-blue-500 px-4 py-4 md:px-8 md:py-5 text-white shadow-md sticky top-0 z-20 md:static md:z-auto">
          <div className="flex items-center gap-3">
            ...
            <div>
            <h2 className="text-2xl font-bold tracking-wide">เพิ่มครุภัณฑ์ใหม่</h2>
            <p className="text-blue-100 text-sm opacity-90">กรอกรายละเอียดครุภัณฑ์เพื่อนำเข้าระบบ</p>
          </div>
          </div>
